...
description: "消费者购买动机深度分析，基于23年品牌营销实战经验洞察真实购买动机。当用户需要产品定位决策、营销策略制定、消费者洞察研究或品牌诊断分析时使用。找到用户心里的开关，让销量突破瓶颈"
metadata:
  author: 小叮当 & JOJO
  version: 1.2.0
  category: 营销洞察
  tags: [销量提升, 消费者心理, 购买动机, 情感诉求, 用户洞察]
  triggers: ["购买动机", "消费者为什么买", "用户需求分析", "产品动机", "用户痛点", "用户场景", "JTBD"]
---
